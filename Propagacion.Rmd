...
data3 = data2 %>%
  ...
  mutate(Departamento = ifelse(REGION=="CALLAO","LIMA",REGION)) %>%
...
m1 = departamento %>%
  ...
  ggrepel::geom_label_repel(
    ...
    scale_x_discrete()+
    labs(caption =paste0("Los casos de Callao se cuentan en Lima\n", "Actualizado al ", format(as.Date(max(data$Dia)),"%d/%m")),
         fill= "Casos") +
  theme_bw()+
