...
```{r Panelf3, message=FALSE, echo=FALSE, eval=FALSE}
## Proporción de casos positivos del total de pruebas analizadas (x dia)

No estamos ploteando esto por que es incorrecto
...
m1 = departamento %>%
  ...
  ggplot() +
    ...
    scale_fill_manual(values = c("grey80", colorRampPalette(colors = c("#FFF5F0","#FB6A4A", "#67000D"))(12))) + #reemplazar numero por n de levels en factor(casos) - 1
