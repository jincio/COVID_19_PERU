...
Por ahora solo incluímos pruebas moleculares.
...
## Proporción de casos positivos del total de pruebas analizadas (INCLUYENDO PRUEBAS RÁPIDAS).

```{r Panelf9, message=FALSE, echo=FALSE}
# Panel para publicacion
panel<- ggarrange(f9,
          ncol=1,nrow=1,
          font.label = list(size = 10, color = "black", face = "bold", family = NULL))
