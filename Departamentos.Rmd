...
### Gif casos positivos 
<p align = center>
![Gif](./Imagenes/peruheatmap-es-covid-hasta-abril-21.gif)</p>

### Gif Fallecidos 
<p align = center>
![Gif](./Imagenes/peruheatmap-es-fallecidos-covid-hasta-abril-21.gif)</p>
...
knitr::include_graphics('./Imagenes/tendenciaCaso10-nacional-departamento-abril-21.png')
```

```{r echo=FALSE, out.width='80%'}
knitr::include_graphics('./Imagenes/tendenciaCaso100-nacional-departamento-abril-21.png')
```

```{r echo=FALSE, out.width='80%'}
knitr::include_graphics('./Imagenes/tendenciaFallecimiento3-nacional-departamento-abril-21.png')
```
