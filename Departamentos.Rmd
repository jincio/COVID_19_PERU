...
data3 = data2 %>%
  ...
  dplyr::summarise(casos = sum(Positivos_PCR))
...
knitr::include_graphics('./Imagenes/tendencia-nacional-departamento-abril-6.png')
```
