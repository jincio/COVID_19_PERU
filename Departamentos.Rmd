...
![Gif](./Imagenes/peruheatmap-es-covid-enero-abril-6.gif)
...
knitr::include_graphics('./Imagenes/tendenciaCaso10-nacional-departamento-abril-8.png')
```

```{r echo=FALSE, out.width='80%'}
knitr::include_graphics('./Imagenes/tendenciaCaso100-nacional-departamento-abril-8.png')
```

```{r echo=FALSE, out.width='80%'}
knitr::include_graphics('./Imagenes/tendenciaFallecimiento3-nacional-departamento-abril-8.png')
```
